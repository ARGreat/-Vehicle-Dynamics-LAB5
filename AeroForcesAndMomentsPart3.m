function [aero_forces, aero_moments] = AeroForcesAndMomentsPart3(t, doublet_size,doublet_time, aircraft_state, aircraft_surfaces, wind_inertial, density, aircraft_parameters)
%
% 
